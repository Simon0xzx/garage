...
from garage.torch.algos import ORACLESAC2
from garage.torch.algos.oracle_sac2 import ORACLESAC2Worker
from garage.torch.embeddings import MLPEncoder
from garage.torch.policies import (OracleConditionedPolicy, TanhGaussianMLPPolicy)
...
@click.option('--num_initial_steps', default=400)
...
@click.option('--prefix', default='oracle')
@wrap_experiment
def oracle_paper_ml1(ctxt=None,
                             seed=1,
                             num_epochs=1000,
                             num_train_tasks=50,
                             num_test_tasks=10,
                             ...
                             prefix='pearl_suit',
                             use_gpu=True):
    """Train Oracle with ML1 environments.
    Args:
    ...
    sampler = LocalSampler(agents=None,
                           ...
                           n_workers=1,
                           worker_class=ORACLESAC2Worker)
    trainer = Trainer(ctxt)

    # instantiate networks
    augmented_env = ORACLESAC2.augment_env_spec(env[0](), latent_size)
    ...
    trainer.setup(algo=oracle,env=env[0]())
