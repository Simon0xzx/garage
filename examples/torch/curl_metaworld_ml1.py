...
@click.option('--num_steps_per_epoch', default=4000)    # number of train per iter TODO here 4000
@click.option('--num_initial_steps', default=4000)      # TODO here 4000
...
@click.option('--prefix', default='curl_wasserstein')
@wrap_experiment
def curl_metaworld_ml1(ctxt=None,
                        seed=1,
                        num_epochs=200,
                        num_train_tasks=50,
                        num_test_tasks=10,
                        ...
                        prefix='curl',
                        use_gpu=True):
    """Train CURL with ML1 environments.
    Args:
