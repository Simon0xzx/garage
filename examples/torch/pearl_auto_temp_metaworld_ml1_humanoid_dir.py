...
from garage.envs.mujoco import HumanoidDirEnv
...
@wrap_experiment
def pearl_origin_auto_temp_traj_humanoid_dir(ctxt=None,
                             seed=1,
                             num_epochs=1000,
                             num_train_tasks=50,
                             num_test_tasks=10,
...
if __name__=='__main__':
    pearl_origin_auto_temp_traj_humanoid_dir()
