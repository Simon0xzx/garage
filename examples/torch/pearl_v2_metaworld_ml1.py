...
from garage.torch.algos.pearl import PEARLV2Worker
...
@click.option('--prefix', default='pearl_v2')
@wrap_experiment
def pearl_v2_metaworld_ml1(ctxt=None,
                           seed=0,
                           num_epochs=1000,
                           num_train_tasks=50,
                           latent_size=7,
                           ...
                           num_tasks_sample=15,
                           num_steps_prior=800,
                           num_extra_rl_steps_posterior=800,
                           batch_size=256,
                           ...
                           name='reach-v1',
                           prefix='pearl_v2'):
    """Train PEARLV2 with ML1 environments.
