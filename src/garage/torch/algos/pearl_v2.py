"""PEARLV2 and PEARLV2Worker in Pytorch.
...
class PEARLV2(MetaRLAlgorithm):
    ...
    def _update_target_network(self):
        """Update parameters in the target qf network."""
        online_nets = [self._qf1, self._qf2]
        target_nets = [self._target_qf1, self._target_qf2]
...
class PEARLV2Worker(DefaultWorker):
