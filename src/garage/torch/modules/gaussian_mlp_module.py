...
class GaussianOracleEmphasizedTwoHeadedModule(GaussianMLPBaseModule):
    """GaussianMLPModule which has only one mean network.
    ...
    def __init__(self,
                 ...
                 layer_normalization=False,
                 normal_distribution_cls=Normal):
        super(GaussianOracleEmphasizedTwoHeadedModule,
              self).__init__(input_dim=input_dim,
                             output_dim=output_dim,
                             hidden_sizes=hidden_sizes,
                             hidden_nonlinearity=hidden_nonlinearity,
        ...
        self._shared_mean_log_std_network = MultiHeadedOracleEmphasizedModule(
            n_heads=2,
            input_dim=self._input_dim,
            output_dims=self._action_dim,
