...
from garage.envs.mujoco.humanoid_env_meta_base import HumanoidEnvMetaBase  # noqa: E501


class HumanoidDirEnv(HumanoidEnvMetaBase):
    ...
    def step(self, action):
        ...
        Equivalent to step in HumanoidEnv, but with different rewards.
