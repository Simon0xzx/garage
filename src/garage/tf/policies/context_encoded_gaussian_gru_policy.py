...
class ContextEncodedGaussianGRUPolicy(GaussianGRUModel, Policy):
    """Gaussian GRU Policy.
    ...
    def __init__(self,
        ...
        self._input_dim = self._input_dim + self._latent_dim
    ...
    def get_action(self, observation):
        ...
        """
        z_var = self._query_encoder.get_latent(observation)[0]
        actions, agent_infos = self.get_actions(np.concatenate([observation, z_var]))
